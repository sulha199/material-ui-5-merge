...
function Autocomplete(props) {
    const { ...other } = props;
    return (_jsx(AutocompleteM, { ...other, disablePortal: true, id: "combo-box-demo", sx: { width: PropTypes.width }, renderInput: (params) => _jsx(TextField, { ...params, label: props.label }) }));
}
