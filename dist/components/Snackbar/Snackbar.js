...
export default function Snackbar(props) {
    ...
    const action = (_jsxs(_Fragment, { children: [undo && (_jsx(Button, { color: "primary", size: "small", onClick: () => setIsOpen(false), children: "Undo" })), _jsx(IconButton, { size: "small", "aria-label": "close", color: "inherit", onClick: () => setIsOpen(false), children: "close" })] }));
    return (_jsx(OriginalSnackbar, { ...other, onClose: handleClose, open: isOpen, anchorOrigin: anchorOrigin, action: action, ref: uxpinRef, sx: styles }));
}
Snackbar.propTypes = {
    /**
