...
const actions = [
    { icon: _jsx(FileCopyIcon, {}), name: 'Copy' },
    { icon: _jsx(SaveIcon, {}), name: 'Save' },
    { icon: _jsx(PrintIcon, {}), name: 'Print' },
    { icon: _jsx(ShareIcon, {}), name: 'Share' },
];
/**
...
export default function SpeedDial(props) {
    ...
    return (_jsxs(Box, { sx: { height: 330, transform: 'translateZ(0px)', flexGrow: 1 }, children: [_jsx(Backdrop, { open: open }), _jsx(SpeedDialM, { ariaLabel: "SpeedDial tooltip example", sx: { position: 'absolute', bottom: 16, right: 16 }, icon: _jsx(SpeedDialIcon, {}), onClose: handleClose, onOpen: handleOpen, open: open, ...props, children: actions.map((action) => (_jsx(SpeedDialAction, { icon: action.icon, tooltipTitle: action.name, tooltipOpen: true, onClick: handleClose }, action.name))) })] }));
}
SpeedDial.propTypes = {
    /**
