...
function Alert(props) {
    ...
    return (_jsx(Collapse, { in: open, children: _jsxs(AlertM, { ...otherProps, icon: icon ? _jsx(Icon, { fontSize: "inherit", children: icon }) : false, action: props.hasClose ? (_jsx(IconButton, { "aria-label": "close", color: "inherit", size: "small", onClick: () => {
                    setOpen(false);
                }, children: props.action })) : null, sx: { mb: 2 }, children: [title ? _jsx(AlertTitle, { children: title }) : null, props.children] }) }));
}
Alert.propTypes = {
