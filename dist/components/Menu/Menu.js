...
export default function Menu(props) {
    ...
    return (_jsxs("div", { children: [props.trigger === 'icon' ? (_jsx(IconButton, { "aria-label": props.label, "aria-haspopup": "true", onClick: handleClick, color: props.color, children: _jsx(Icon, { children: props.icon }) })) : (_jsx(Button, { "aria-haspopup": "true", variant: props.buttonVariant, color: props.color, onClick: handleClick, children: props.label })), _jsx(MenuM, { id: "basic-menu", anchorEl: anchorEl, open: open, onClose: handleClose, MenuListProps: {
                    'aria-labelledby': 'basic-button',
                }, children: props.children.map((item, key) => {
                    {
                        console.log(item.props.children);
                    }
                    return _jsx(MenuItem, { onClick: handleClose, ...item.props }, key);
                }) })] }));
}
Menu.propTypes = {
    open: PropTypes.bool,
