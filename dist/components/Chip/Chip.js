...
export default function Chip(props) {
    ...
    const { ...other } = props;
    return (_jsx(_Fragment, { children: !chipDeleted ? (_jsx(ChipM, { ...other, onDelete: props.deletable
                ? () => {
                    props.onDelete;
                    setChipDeleted(true);
                }
                : null, avatar: props.avatar ? props.avatar : null, icon: props.icon ? _jsx(Icon, { children: props.icon }) : null, deleteIcon: props.deleteIcon ? _jsx(Icon, { children: props.deleteIcon }) : null })) : null }));
}
Chip.propTypes = {
    /**
