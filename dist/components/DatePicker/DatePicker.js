...
function DatePicker(props) {
    return (_jsx(LocalizationProvider, { dateAdapter: AdapterDateFns, children: _jsx(DatePickerM, { ...props, renderInput: (params) => _jsx(TextField, { ...params, helperText: props.helperText }) }) }));
}
