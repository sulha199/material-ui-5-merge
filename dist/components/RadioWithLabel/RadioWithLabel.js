...
function RadioWithLabel(props) {
    return (_jsx(FormControlLabelM, { ...props, htmlFor: "radioWithLabel", control: _jsx(Radio, { id: "radioWithLabel", inputProps: { role: 'radio', 'aria-checked': props.checked }, color: props.color, size: props.size }), label: props.label }));
}
...
//# sourceMappingURL=RadioWithLabel.js.map