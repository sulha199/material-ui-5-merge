...
export default function SplitButton(props) {
    ...
    return (_jsxs(React.Fragment, { children: [_jsxs(ButtonGroup, { variant: props.variant, ref: anchorRef, "aria-label": "split button", children: [_jsx(Button, { onClick: handleClick, children: options[selectedIndex] }), _jsx(Button, { size: "small", "aria-controls": open ? 'split-button-menu' : undefined, "aria-expanded": open ? 'true' : undefined, "aria-label": "hello", "aria-haspopup": "menu", onClick: handleToggle, children: _jsx(Icon, { children: "arrow_drop_down" }) })] }), _jsx(Popper, { open: open, anchorEl: anchorRef.current, role: undefined, transition: true, disablePortal: true, children: ({ TransitionProps, placement }) => (_jsx(Grow, { ...TransitionProps, sx: {
