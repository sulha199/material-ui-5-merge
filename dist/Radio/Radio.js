...
function Radio(props) {
    return (_jsx(RadioM, { ...props, icon: props.icon ? _jsx(Icon, { children: props.icon }) : _jsx(Icon, { children: "radio_button_unchecked" }), checkedIcon: props.checkedIcon ? _jsx(Icon, { children: props.checkedIcon }) : _jsx(Icon, { children: "radio_button_checked" }) }));
}
Radio.propTypes = {
    /**
