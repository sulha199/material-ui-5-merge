...
function Select(props) {
    ...
    return (_jsx(SelectM, { labelId: "demo-multiple-name-label", id: "demo-multiple-name", onChange: (e) => handleChange(e), onOpen: props.onOpen, onClose: props.onClose, value: selectedValue, label: props.label, ...props, children: props.children }));
}
Select.propTypes = {
    /**
