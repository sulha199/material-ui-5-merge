...
function CheckboxWithLabel(props) {
    // Unique Id
    const id = uuidv4();
    return (_jsx(FormControlLabelM, { ...props, htmlFor: id, control: _jsx(Checkbox, { id: id, inputProps: { role: 'switch', 'aria-checked': props.checked }, size: props.size, color: props.color, checked: props.checked }), label: props.label }));
}
