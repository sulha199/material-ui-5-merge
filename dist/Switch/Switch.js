...
function Switch(props) {
    return (_jsx(SwitchM, { ...props, icon: props.icon ? _jsx(Icon, { fontSize: "small", children: props.icon }) : null, checkedIcon: props.checkedIcon ? _jsx(Icon, { fontSize: "small", children: props.checkedIcon }) : null }));
}
Switch.propTypes = {
    /**
